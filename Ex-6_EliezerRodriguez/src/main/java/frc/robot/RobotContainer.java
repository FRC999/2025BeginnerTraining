...
public class RobotContainer {
  ...
  public static LimitSwitchSubsystem limitSwitchSubsystem = new LimitSwitchSubsystem();
  ...
  private void configureBindings() {
    ...
    new Trigger(() -> limitSwitchSubsystem.GetSwitchValue() && joystick.getRawButton(1))
